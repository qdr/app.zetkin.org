...
interface SuborgOverviewPageClientProps {
  orgId: number;
}

const SuborgOverviewPageClient: FC<SuborgOverviewPageClientProps> = ({
  orgId,
}) => {
  const [selectedSuborgId, setSelectedSuborgId] = useState<number | null>(null);

  return (
    <SuborgOverviewLayout>
...
export default SuborgOverviewPageClient;

...
const AreaAssignmentReportPage = () => {
  ...
  const areaAssignmentFuture = useAreaAssignment(orgId, areaAssId);
  const areaAssignmentStats = useAreaAssignmentStats(orgId, areaAssId).data;
  const messages = useMessages(messagesIds);
  const { showConfirmDialog } = useContext(ZUIConfirmDialogContext);
  const metricsList = useAreaAssignmentMetrics(orgId, areaAssId);

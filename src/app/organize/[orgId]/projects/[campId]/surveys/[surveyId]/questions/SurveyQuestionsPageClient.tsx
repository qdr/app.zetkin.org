...
interface SurveyQuestionsPageClientProps {
  orgId: number;
  surveyId: number;
}

const SurveyQuestionsPageClient: FC<SurveyQuestionsPageClientProps> = ({ orgId, surveyId }) => {
...
export default SurveyQuestionsPageClient;
